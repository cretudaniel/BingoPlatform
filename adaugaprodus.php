...
$date= $y.$m.$d;
// echo $date;
$query = mysqli_query($db, "INSERT INTO items(name, price, category, location, photo, user_name, date, phone, description, year) VALUES ('$nume_safe', '$pret_safe', '$categorie_safe', '$locatie_safe', '$imagine_nume', '$username', '$date', '$phone', '$description', '$year')");
